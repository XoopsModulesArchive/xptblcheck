<?php
// $Id: xptblcheck_debugshow.php,v 2.02g 2003/10/15 15:50:00 toshimitsu Exp $
//------------------------//
...
global $xoopsModule;
    ...
    if (isset($xoopsModule)) {
    	...
    	$config_list =& $config_handler->getConfigList($temp_arr['mid']);
    	$block['content'] .= b_xptblcheck_showarraysub("Module¡¡Config",$config_list);
/*    
    	$config_obj =& $config_handler->getConfigs(NULL,true);
       	foreach ($$config_obj as $k) {
    		$configoption_list =& $config_handler->getConfigOptions($k);
    		$block['content'] .= b_xptblcheck_showarraysub("Module¡¡ConfigOption",$configoption_list);
       	}
*/
    }	
